...
<div class="admin-wrapper">
    <div class="admin-sidebar">
        <a href="<%=ctxPath%>/admin/index" class="active"><i class="fa-solid fa-gauge-high"></i> 控制台</a>
    ...
    <div class="admin-main">
        ...
        <div class="card">
            ...
            <div style="display:flex;gap:12px;flex-wrap:wrap;">
                <a href="<%=ctxPath%>/admin/users" class="btn btn-primary"><i class="fa-solid fa-users"></i>&nbsp; 用户管理</a>
                <a href="<%=ctxPath%>/admin/items" class="btn btn-outline"><i class="fa-solid fa-clipboard-check"></i>&nbsp; 审核信息</a>
                <a href="<%=ctxPath%>/admin/categories" class="btn btn-outline"><i class="fa-solid fa-folder-plus"></i>&nbsp; 管理分类</a>
                <a href="<%=ctxPath%>/admin/notices" class="btn btn-outline"><i class="fa-solid fa-pen-to-square"></i>&nbsp; 发布公告</a>
            </div>
        </div>
    </div>
</div>
