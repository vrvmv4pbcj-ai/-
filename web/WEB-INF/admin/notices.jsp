...
<div class="admin-wrapper">
    <div class="admin-sidebar">
        ...
        <a href="<%=ctxPath%>/admin/notices" class="active"><i class="fa-solid fa-bullhorn"></i> 公告管理</a>
    </div>
    <div class="admin-main">
        ...
        <div class="card" style="margin-bottom:20px;">
            ...
            <form action="<%=ctxPath%>/admin/notices?action=add" method="post">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<%=ctxPath%>/admin/notices?action=noticeDelete&id=<%= n.getId() %>" class="btn btn-danger btn-sm" onclick="return confirm('确定删除?')"><i class="fa-solid fa-trash"></i></a></td>
                    </tr><% } %>
                </tbody>
            </table>
        </div>
